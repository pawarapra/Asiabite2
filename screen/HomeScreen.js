        ...
        <View style={styles.container}>
          <View style={styles.section1}>
            ...
            <Text style={styles.subhead}>
              Step into the flavorful universe of asiabite!
            </Text>
          </View>
          <View style={styles.section2}>
            <Text style={styles.section2text}>
              Get your favorite Asian snacks delivered to your door, in the flavors you love. Enjoy them anytime, anywhere!
            </Text>
            <View style={styles.section2left}>
              <Image 
                style={styles.section2Image} 
                source={require('../assets/boxbasic.png')} 
              />
            </View>
          </View>
